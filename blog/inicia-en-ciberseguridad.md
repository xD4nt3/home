# ¿Quieres iniciar en Ciberseguridad? Pues Hazlo, Holgazán
...
> El que lo logra es el que no se rinde cuando el primer tutorial no tiene sentido, cuando la máquina de HackTheBox no se hackea sola, o cuando olvida por décima vez qué hace el flag `-pN` en nmap.
...
1. **TryHackMe** → Empieza aquí. Es como HackTheBox pero con rueditas de entrenamiento y suelo de espuma
2. **HackTheBox** → Cuando TryHackMe se sienta fácil, ven acá
3. **VulnHub** → Máquinas descargables para practicar offline
4. **PROFFSEC Academy** → Cuando estén disponibles los benditos cursos, tengan paciencia >:)
...
1. **Cerrar esta pestaña** y seguir "pensándolo" otros 6 meses
2. **Abrir una terminal** y escribir tu primer comando de Linux
